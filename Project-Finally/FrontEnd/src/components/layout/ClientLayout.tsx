...
const ClientLayout: React.FC<ClientLayoutProps> = ({ children }) => {
  ...
  // Lấy fullname từ localStorage khi component mount
  React.useEffect(() => {
    const loadUserFullname = async () => {
      try {
        ...
        console.error('Error loading user fullname:', error);
      }
    };
            ...
            <>
              ...
              >
                <Avatar sx={{ bgcolor: 'secondary.main', width: 32, height: 32 }}>
                  {userFullname ? userFullname.charAt(0).toUpperCase() : (user?.firstName?.charAt(0) || 'U')}
                </Avatar>
              </IconButton>
              <Menu
                anchorEl={anchorEl}
