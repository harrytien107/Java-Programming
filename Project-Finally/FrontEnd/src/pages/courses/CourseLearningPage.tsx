  ...
  return (
    <ClientLayout>
      <Box sx={{ display: 'flex', minHeight: 'calc(100vh - 128px)' }}>
        ...
        >
          <Box sx={{ p: 2 }}>
            <Typography variant="h6" sx={{ mb: 2 }}>Nội dung khóa học</Typography>
        ...
        <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Paper sx={{ p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography variant="h6">
              {currentLesson?.name || 'Chọn bài học'}
            </Typography>
            ...
            {currentLesson ? (
              <Card>
                <CardContent>
                  ...
                  {currentLesson.video && (
                    <Box sx={{ mb: 3 }}>
                      <video
                        ...
                        height="400"
                        controls
                        src={courseService.getVideoUrl(currentLesson.video)}
                  ...
                  <Box sx={{ mb: 3 }}>
                    <Typography variant="h6" gutterBottom>Mục đích bài học</Typography>
                    <Box
                      sx={{
                        mb: 3,
                        '& p': { margin: '8px 0' },
                    ...
                    <Typography variant="h6" gutterBottom>Nội dung bài học</Typography>
                    <Box
                      sx={{
                        '& p': { margin: '8px 0' },
                        '& ul, & ol': { paddingLeft: '20px' },
