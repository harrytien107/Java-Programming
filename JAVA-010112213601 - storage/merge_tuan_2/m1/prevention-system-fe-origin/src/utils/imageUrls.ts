// Hình ảnh cho trang chủ
export const heroImage = 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80';
export const aboutUsImage = 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80';

// Hình ảnh cho khóa học
...
// Hình ảnh cho chương trình cộng đồng
export const programImages = [
  'https://images.unsplash.com/photo-1529390079861-591de354faf5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
...
export const serviceIcons = {
  courses: 'https://cdn-icons-png.flaticon.com/512/2436/2436874.png',
  surveys: 'https://cdn-icons-png.flaticon.com/512/3588/3588614.png',
  appointments: 'https://cdn-icons-png.flaticon.com/512/2693/2693507.png',
  programs: 'https://cdn-icons-png.flaticon.com/512/745/745205.png',
};

// Hình ảnh cho chuyên viên tư vấn
export const consultantImages = [
  ...
  'https://images.unsplash.com/photo-1573497019236-61e7a3e1f341?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
];

// Logo
export const logo = 'https://cdn-icons-png.flaticon.com/512/3588/3588658.png';
